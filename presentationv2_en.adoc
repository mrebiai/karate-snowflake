...
🇫🇷 _votre partenaire de combat dans l'arène des tests API_

🇬🇧 _your battle partner in the API testing arena_
...
|===
| | Ok? | Comments
| Snowflake | ✅ | But complex API
| Kafka | ❌ | Closed source addon
| Rabbitmq | ❌ | Just code example for addon
| DBT | ✅ | Thanks to `karate.exec(...)`
|===

== 💡 Karate Connect =+++<br/>+++Karate Core + Extensions ready to use
...
image:diagrams/burger-factory.svg[width=500]
